    ...
    <div class="table-data">
      <el-form :model="formData" :rules="rules" ref="formData" label-width="100px">
        ...
        <el-form-item label="地址：">
          <el-col :span="8">
            <el-input type="text" size="medium" v-model="formData.href" placeholder="请输入地址"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="图标：">
          <el-col :span="8">
            <el-input type="text" size="medium" v-model="formData.icon" placeholder="请输入图标名称"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="排序：">
          <el-col :span="8">
            <el-input type="text" size="medium" v-model="formData.sort" placeholder="请输入序号"></el-input>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="　">
          <el-col :span="8">
            <el-button type="primary" size="medium" @click="sub()">提交</el-button>
          </el-col>
        </el-form-item>
      </el-form>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      sub () {
        ...
        axios.post(URL.api_name + 'cloud/security/menu_add', that.formData).then(function (res) {
          if (res.data.code === '100') {
              that.$message({
                type: 'success',
                message: '提交成功',
