<template>
	<div class="lists">
		<div class="contentTitle pdlr20">添加血液知识库</div>
		...
		<div class="examinedatainfo" v-show="showTab === 3">
			<table>
				...
				<tr>
					...
					<td>
						<div style="margin:10px;" v-for="(obj, index) in data2.prognosis" :key="index">
							...
							<div class="source">
								...
								<span style="display:inline-block;width:10em;">
									<el-select v-model="obj.key" placeholder="预后情况">
				...
				<tr>
					...
					<td>
						<div style="margin:10px;" v-for="(obj, index) in data2.pathogenesis" :key="index">
							...
							<div class="source">
								...
								<span style="display:inline-block;width:10em;">
									<el-select v-model="obj.key" placeholder="疾病相关">
...
<script>
	...
	export default {
		...
		methods: {
			...
			addsummarys() {
				let that = this
				if(that.data2.conclusions.length < 3) {
