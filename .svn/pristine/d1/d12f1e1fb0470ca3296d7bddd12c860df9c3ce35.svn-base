<template>
  <div class="lists">
    <div class="main-cont1">
      <h2 class="main--h1"><a href="javascript:;" class="fr" @click="goMore('999')">更多</a>{{ msg }}</h2>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goMore (id) {
        localStorage.setItem('serviceCreatType', 'creat')
        this.$router.push({
          path: '/Processlist/' + id
        })
      },
...
<style scoped>
	...
	.main--h1:before{content:''; background:#008AFF; display: inline-block; width: 3px; height:18px;margin:0px 8px -3px 0px; border-radius: 2px;}
