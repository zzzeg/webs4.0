<template>
	<div class="side-menu">
		...
		<div class="showimg">
			<img src="../common/icons/homes/nav_menu.png" alt="" @click="changecollpase">
		</div>
		<!-- <i class="el-icon-tickets changeCollapse" @click="changecollpase"></i> -->
		<el-menu class="el-menu-vertical-demo" router unique-opened :collapse="isCollapse" :default-active="routers">
			<!-- 下拉菜单 -->
