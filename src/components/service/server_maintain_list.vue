<template>
  <div class="list">
    <div class="contentTitle pdlr20">维护列表</div>
    ...
    <div class="table-data"
      ...
      <el-table :data="tableData" stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="260">
          <template slot-scope="scope">
            <el-button type="text" @click="goBind(scope.row.code, currentPage)">绑定</el-button>
            <el-button type="text" @click="goEdit(scope.row.code, currentPage)">修改</el-button>
            <el-button type="text" @click="showCopyLog(scope.row.code)">复制</el-button>
    ...
    <el-dialog title="选择瘤种" :visible.sync="copylog" width="50%">
      <el-row :gutter="10">
        <el-col :span="24">
