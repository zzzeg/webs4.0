<template>
  <div class="list">
    <div class="contentTitle pdlr20">用户管理</div>
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column label="操作" width="230">
              <template slot-scope="scope">
                ...
                <el-button type="text" @click="resetPwd(scope.row.userName)">重置密码</el-button>
                <el-button type="text" v-if="scope.row.status !== 1" @click="deleteTicket(scope.row.userName)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
