<template>
  <div class="list" style="position:relative; height:100%; background:none;">
    ...
    <div class="rightContent" v-loading="blockLoading" style="position:relative; height:calc(100%);">
      ...
      <pxbyjcjgzl :formDatas="reportData" v-else-if="navItemSession.blockCode == '15687997063510585'"><!--胚系变异检测结果总览--></pxbyjcjgzl>

      <zlygjyjcjg :formDatas="reportData" v-else-if="navItemSession.blockCode == '15687994307068186'"><!--胚系变异检测结果总览--></zlygjyjcjg>
      ...
      <jgjx :formDatas="reportData" @saveChange="saveChange" v-else-if="navItemSession.blockCode == '15302351321171784'"><!--其他结果解析--></jgjx>
    ...
    <div class="orderDetial" v-if="orderVisable" style="top:100px;right:100px;">
      ...
      <div class="odcontent">
        ...
        <h5>附件</h5>
        <div class="filesPic" v-if="orderInfo.projectFiles.length > 0"><!--URL.api_name + 'proai/downloadImageFile?fileDownUrl=' + orderInfo.projectFiles[picindex].fileDownUrl +
...
<script>
  ...
  import pxbyjcjgzl from '@/components/examine/examineModel/pxbyjcjgzl'
  import zlygjyjcjg from '@/components/examine/examineModel/zlygjyjcjg'
  ...
  export default{
      ...
      blockSearch (itemText, num, sort, sortType) {
        ...
        switch(itemText.blockCode) {
          ...
          case '15336939611434715': // 常见用药标志物检测结果
            ...
            break
          case '15687997063510585': // 常见用药标志物检测结果
            geturls = 'report/clinicalNote/loadGemlineVariantOverview'
            condition = {
              pageNumber: num,
              pageSize: that.pageSize,
              projectCode: that.code
            ...
            break
          case '15687994307068186': // 肿瘤易感基因检测结果
            geturls = 'report/clinicalNote/loadGemlineVariantOverview'
            condition = {
              pageNumber: num,
              pageSize: that.pageSize,
    ...
    components: {
      ...
      jcjylb,qtbxzlfaxq,qtmyzlfaxq,qthlzlfaxq,qtyhxgxxxq,bxzlxgjczl,myzlxgjcjgzl,hlxgjcjgzl,nfmxgjcjgzl,qtbyzl,yjbxgrd,knyjbxgrd,qtzytbwdjx,brca,arrar,hlywzl,nfmywzl,jcjg,jgjx,zlfxjx,pxbyjcjgzl,zlygjyjcjg
    },
    computed: {
      uploadHeader () {
        return {
