  ...
  <div class="base_msg blockContent">
	<div class="subItems">
   	<div class="subtitle dtitleBg" >
		 ...
		 <p style="color: #555;font-size: 14px;margin:50px 0 0 0;"><strong>说明：</strong>乳腺癌 21 基因检测使用分支 DNA-液相芯片技术检测肿瘤组织中 21 个基因的表达情况。复发分数（RS 评分）是根据基因表达的结果计算得来的，复发分数的范围从 0-100。复发分数越低的乳腺癌患者，其 10 年远期复发风险越低，接受他莫西芬+化疗的治疗方案获益不显著。 </p>
    </div>
	</div>
  </div>
</template>
