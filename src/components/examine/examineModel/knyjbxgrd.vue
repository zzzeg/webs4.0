	...
	<div class="base_msg blockContent">
		<div class="subItems">
			...
			<el-table class="tableList hasLine" :data="formData1.list" empty-text="未检测到相关结果" stripe  style="width: 100%">
				...
				<el-table-column prop="variant" label="突变位点" width="200">
				</el-table-column>
				...
				<el-table-column prop="bloodClinicalSignificance" label="临床意义">
					<template slot-scope="scope">
						<span :class="{'color_red' : bloodClinicalSignificanceBySystem == 1}">{{ scope.row.bloodClinicalSignificance }}</span>
					</template>
				</el-table-column>
