  ...
  <div class="base_msg blockContent">
    <div class="subItems">
      ...
      <div class="table-cont" style="position:relative">
          ...
          <span style="display:inline-block; width:9%; line-height:20px; padding:15px 10px; margin:-1px 0 0 -1px; font-size:14px; border:solid 1px #eee; box-sizing:border-box;" v-for="(i, index) in formData1.mutation" :key="index" :class="i | hasName(formData1.mutationgenes) && shapeType == '1' ? 'color_red': ''">
              {{ i }}
          </span>
      </div>

      <div class="table-cont" style="position:relative" v-if="formData1.amplification.length > 0">
          <div class="h_title">
          拷贝数变异
      ...
      <div class="table-cont" style="position:relative" v-if="formData1.fusion.length > 0">
          <div class="h_title">
          基因融合
