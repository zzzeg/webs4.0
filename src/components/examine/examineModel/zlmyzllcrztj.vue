  ...
  <div class="base_msg blockContent">
    <div class="subItems">
      ...
      <div class="addBar" style="padding:0px 0 10px 0; text-align:right;">
        ...
        <el-button type="primary" size="medium" @click="updateClinical(2)">更新入组</el-button>
      </div>
      ...
      <div class="table-cont" v-for="(recommended, index) in formData1.list" :key="index" v-else>
        <table>
          <tr>
              <td width="150"></td>
              <td></td>
