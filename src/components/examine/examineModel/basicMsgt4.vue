<template>
	<div class="base_msg blockContent">
		<div class="subItems">
          ...
          <!--<el-col :span="8"><span class="color_bask">国籍：</span>-->
            <!--<div class="tableListItem" v-if="!block1">{{ formData.race }}&nbsp;</div>-->
            <!--<el-input class="editFrom" v-if="block1" v-model="formData1.race" placeholder="国籍"></el-input>-->
          <!--</el-col>-->
          <el-col :span="8"><span class="color_bask">报告编号：</span>
            <div class="tableListItem" v-if="!block1">{{ formData.projectCode }}&nbsp;</div>
            <el-input class="editFrom" v-if="block1" v-model="formData1.projectCode" placeholder="订单号"></el-input>
          </el-col>

					<el-col :span="8"><span class="color_bask">联系方式：</span>
						<div class="tableListItem" v-if="!block1">{{ formData.phone }}&nbsp;</div>
						<el-input class="editFrom" v-if="block1" v-model="formData1.phone" placeholder="联系方式"></el-input>
					</el-col>
				</el-row>
		...
		<div class="subItems">
			...
			<div class="inlineItem">
				<el-row :gutter="10">
					<el-col :span="24">
						<div class="tableListItem" style="margin-left:0" v-if="!block3">{{ formData1.clinicalDiagnosis }}&nbsp;</div>
						<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" class="editFrom" style="width:100%;" v-if="block3" v-model="formData1.clinicalDiagnosis"
		...
		<div class="subItems" v-if="productType != '21'">
			...
			<div class="inlineItem">
				<el-row :gutter="10">
					<el-col :span="24">
						<div class="tableListItem" style="margin-left:0" v-if="!block4">{{ formData.pathologyDiagnosis }}&nbsp;</div>
						<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" class="editFrom" style="width:100%;" v-if="block4" v-model="formData1.pathologyDiagnosis"
		...
		<div class="subItems" v-if="productType != '21'">
			...
			<div class="inlineItem">
				<el-row :gutter="10">
					<el-col :span="24">
						<div class="tableListItem" style="margin-left:0" v-if="!block5">{{ formData.beforeMedicalHistory }}&nbsp;</div>
						<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" class="editFrom" style="width:100%;" v-if="block5" v-model="formData1.beforeMedicalHistory"
		...
		<div class="subItems" v-if="productType != '21'">
			...
			<div class="inlineItem">
				<el-row :gutter="10">
					<el-col :span="24">
						<div class="tableListItem" style="margin-left:0" v-if="!block6">{{ formData.recentMedicalHistory }}&nbsp;</div>
						<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" class="editFrom" style="width:100%;" v-if="block6" v-model="formData1.recentMedicalHistory" placeholder="现病史"></el-input>
					</el-col>
				</el-row>
			</div>
		</div>
		...
		<div class="subItems" v-if="productType != '21'">
			...
			<div class="inlineItem">
				<el-row :gutter="10">
					<el-col :span="24">
						<div class="tableListItem" style="margin-left:0" v-if="!block7">{{ formData1.familyMedicalHistory }}&nbsp;</div>
						<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" class="editFrom" style="width:100%;" v-if="block7" v-model="formData1.familyMedicalHistory"
	...
	export default {
		...
		methods: {
			adddrug() {
				...
				that.formData1.medicationHistoryList.push(n)
			},
			deldrug(index) {
				let that = this
				that.formData1.medicationHistoryList.splice(index, 1)
			},
