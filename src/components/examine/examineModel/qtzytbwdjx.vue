	...
	<div class="base_msg">
		...
		<div class="details_cont" v-for="(formList, index) in formData1.list" :key="index">
          ...
          疾病相关
				...
				<p style="margin-left:14px;"  v-for="(itemseee, ind) in formList.pathogenesisClinicalNotes" :key="ind">{{ formList.pathogenesisClinicalNotes.length > 1 ? ind + 1 + '.' : '' }}{{ itemseee.bloodDiseaseNote }}</p>
            ...
            style="display: inline-block; vertical-align: middle;"
				    v-model="itemseee.bloodDiseaseNote">
				  </el-input>
          ...
          预后相关
				...
				<p  style="margin-left:14px;">{{ formList.prognosisClinicalNotes == '' ? '无相关结果' : formList.prognosisClinicalNotes }}</p>
