				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<p style="text-align: right; margin:0 10px -30px 0"><el-button type="text" size="mini" @click="addsummarys">添加</el-button></p>
							...
							<p>参考文献：</p>
							<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="请输入参考文献" v-model="data2.literature"></el-input>
						</td>
						...
						<td>
							...
							<p>参考文献：</p>
							<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="参考文献" v-model="data1.literature" disabled></el-input>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div style="margin:10px;">
								...
								<p>预后临床注释：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" id="male" placeholder="请输入结论内容" v-model="data2.prognosisNote"></el-input>
								<p>预后参考文献：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="例子:NCCN Clinical Practice Guidelines in Oncology_Melanoma(Version 2.2018)|||http://www.nccn.org/patients;^PMID$ 26037941|||Long G V, Stroyakovskiy D, Gogas H, et al. Dabrafenib and trametinib versus dabrafenib and placebo for Val600 BRAF-mutant melanoma: a multicentre, double-blind, phase 3 randomised controlled trial[J]. Lancet, 2015, 386(9992):444-451."
								 autosize v-model.trim="data2.prognosisLiterature"></el-input>
								<!-- <p>依&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;据：</p>
						...
						<td>
							<div class="areasource">
								...
								<p>预后临床注释：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="临床注释" v-model="data1.prognosisNote" disabled></el-input>
								<p>预后参考文献：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="参考文献" v-model="data1.prognosisLiterature" disabled></el-input>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div style="margin:10px;">
								...
								<p>疾病临床注释：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" id="male" placeholder="请输入结论内容" v-model="data2.pathogensisNote"></el-input>
								<p>疾病参考文献：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="例子:NCCN Clinical Practice Guidelines in Oncology_Melanoma(Version 2.2018)|||http://www.nccn.org/patients;^PMID$ 26037941|||Long G V, Stroyakovskiy D, Gogas H, et al. Dabrafenib and trametinib versus dabrafenib and placebo for Val600 BRAF-mutant melanoma: a multicentre, double-blind, phase 3 randomised controlled trial[J]. Lancet, 2015, 386(9992):444-451."
								 autosize v-model.trim="data2.pathogensisLiterature"></el-input>
								<!-- <p>依&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;据：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" id="female" placeholder="请输入文本内容" v-model.trim="obj.basis"></el-input> -->
							</div>
						</td>
						<td>
							<div class="areasource" >
								...
								<p>疾病临床注释：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="临床注释" v-model="data1.pathogensisNote" disabled></el-input>
								<p>疾病参考文献：</p>
								<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 8}" placeholder="参考文献" v-model="data1.pathogensisLiterature" disabled></el-input>
							</div>
						</td>
					</tr>
					<tr>
