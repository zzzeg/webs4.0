<template>
  <div class="list" style="position:relative; height:100%; background:none;">
    ...
    <div class="rightContent" v-loading="blockLoading" style="position:relative; height:calc(100%);">
      ...
      <bxzlfaxq :formDatas="reportData" :formInline="formInline" @saveChange="saveChange" @pushListItem="pushListItem" @search="SearchForminline" v-else-if="navItemSession.blockCode == '55' || navItemSession.blockCode == '56' || navItemSession.blockCode == '57'"><!--靶向、免疫、化疗治疗方案详情--></bxzlfaxq>
    ...
    <div class="orderDetial" v-if="orderVisable" style="top:100px;right:100px;">
      ...
      <div class="odcontent">
        ...
        <div class="filesPic">
          <div class="imgParent">
            <div class="xx" :style="'background:url(https://ww3.sinaimg.cn/mw690/6f26315cgw1ejbg4tg69xj21kw11xtwz.jpg) no-repeat; width:' + imgWidth + ';height:' + imgHeight + '; transform: rotate(' + rotate + 'deg); background-size:100% auto;'" @mousedown="move"></div>
          </div>
    ...
    <el-dialog title="maf文件列表" :visible.sync="mafVisable" width="90%">
      ...
      <div class="tableBig">
        <el-table class="tableList hasLine" :data="maflistdata" border stripe style="width: 100%">
          ...
          <el-table-column label="Annotation_Transcript" prop="Annotation_Transcript" width="100" fixed>
          </el-table-column>
          <el-table-column label="cDNA_Change" prop="cDNA_Change" width="100" fixed>
          </el-table-column>
          <el-table-column label="Protein_Change" prop="Protein_Change" width="200">
          </el-table-column>
          <el-table-column label="Other_Transcripts" prop="Other_Transcripts" width="100" fixed>
          </el-table-column>
          ...
          <el-table-column label="Variant_Type" prop="Variant_Type" width="200">
          </el-table-column>
          <el-table-column label="Transcript_Exon" prop="Transcript_Exon" width="200">
          </el-table-column>
          <el-table-column label="CLINSIG" prop="CLINSIG" width="200">
          </el-table-column>
          <el-table-column label="RsId" prop="id" width="200">
          </el-table-column>
          <el-table-column label="allelic_depth" prop="allelic_depth" width="200">
          </el-table-column>
          <el-table-column label="ClinVar_TYPE" prop="ClinVar_TYPE" width="200">
          </el-table-column>
        </el-table>
      </div>
...
<script>
  ...
  export default{
    ...
    components: {
      ...
      jcjylb,qtbxzlfaxq,qtmyzlfaxq,qthlzlfaxq,qtyhxgxxxq,bxzlxgjczl,myzlxgjcjgzl,hlxgjcjgzl,qtbyzl,yjbxgrd,knyjbxgrd,qtzytbwdjx,brca,arrar
    },
    computed: {
      uploadHeader () {
        return {
