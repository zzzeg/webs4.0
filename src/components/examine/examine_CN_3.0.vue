          ...
          <div class="search-wrapper">
            <el-form :inline="true" :model="formInline" class="demo-form-inline query-form">
              ...
              <el-form-item label="变异：">
                <el-input size="medium" v-model="formInline.mutation" placeholder="变异" style="width:90px;"></el-input>
              </el-form-item>
              <el-form-item label="外显子：">
                <el-input size="medium" v-model="formInline.transcriptExon" placeholder="外显子" style="width:90px;"></el-input>
              </el-form-item>
              <el-form-item label="临床意义：">
                <el-input size="medium" v-model="formInline.clinicalSignificance" placeholder="临床意义"  style="width:90px;"></el-input>
              </el-form-item>
              ...
              <el-form-item label="DmDp：">
                <el-input size="medium" v-model="formInline.hgmdDmDp" placeholder="DmDp"  style="width:90px;"></el-input>
              </el-form-item>
              <el-form-item>
