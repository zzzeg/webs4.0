...
import ExamineBlood from '@/components/examine/examine_blood'
import ExamineBloodInfo from '@/components/examine/examine_blood_info'
import ExamineBloodNew from '@/components/examine/examine_blood_new'
...
import ExamineImportantVarient from '@/components/examine/examine_importVarient'
import knowledgeBase from '@/components/examine/knowledgeBase/knowledgeBase'
import knowledgeBaseInfo from '@/components/examine/knowledgeBase/knowledgeBaseInfo'

// 基因注释、变异注释
import ExamineNotes from '@/components/examine/examine_notes'
import ExamineNotesInfo from '@/components/examine/examine_note_info'
...
export default new Router({
    routes: [{
        ...
        {
            path: '/serviceAddCode/:id/:productCode/:pager/:productType',
            name: 'ServiceAddCode',
        ...
        {
            path: '/ExamineBlood/:pager',
            name: 'ExamineBlood',
            component: ExamineBlood
        },
        {
            path: '/ExamineBloodInfo/:id/:pager/:status',
            name: 'ExamineBloodInfo',
            component: ExamineBloodInfo
        },
        {
            path: '/ExamineBloodNew/:pager/:reportVariantCode',
            name: 'ExamineBloodNew',
            component: ExamineBloodNew
        },
        {
        ...
        {
          path: '/ExamineImportantVarient',
          name: 'ExamineImportantVarient',
          component: ExamineImportantVarient
        },{
          path: '/knowledgeBase',
          name: 'knowledgeBase',
        ...
        {
            path: '/ExamineNotes/:pager/:status',
            name: 'ExamineNotes',
            component: ExamineNotes
        },
        {
            path: '/ExamineNotesInfo/:type/:status/:code/:pager',
            name: 'ExamineNotesInfo',
            component: ExamineNotesInfo
        },
        {
